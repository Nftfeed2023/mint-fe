...
interface ERC721TemplateInterface extends ethers.utils.Interface {
  functions: {
    ...
    "viewPageNftInfosOfOwner(address,uint256,uint256)": FunctionFragment;
    "viewPageTokenIdsOfOwner(address,uint256,uint256)": FunctionFragment;
  };
  ...
  encodeFunctionData(
    functionFragment: "viewPageNftInfosOfOwner",
    values: [string, BigNumberish, BigNumberish]
  ): string;
  encodeFunctionData(
    functionFragment: "viewPageTokenIdsOfOwner",
    values: [string, BigNumberish, BigNumberish]
  ): string;
  ...
  events: {
    ...
    "MintBatch(uint256[],address)": EventFragment;
...
export type MintBatchEvent = TypedEvent<
  [BigNumber[], string] & { tokenIds: BigNumber[]; to: string }
>;
...
export class ERC721Template extends BaseContract {
  ...
  functions: {
    ...
    viewPageTokenIdsOfOwner(
      _owner: string,
      _pageIndex: BigNumberish,
      _pageSize: BigNumberish,
      overrides?: CallOverrides
    ): Promise<
      [BigNumber[], BigNumber] & { data: BigNumber[]; total: BigNumber }
    >;
  };
  ...
  viewPageNftInfosOfOwner(
    ...
    [
      ...
      data: ([BigNumber, string] & { tokenId: BigNumber; tokenUri: string })[];
      total: BigNumber;
    }
  >;
  ...
  callStatic: {
    ...
    setBaseUrl(_baseUrl: string, overrides?: CallOverrides): Promise<void>;
  ...
  filters: {
    ...
    "MintBatch(uint256[],address)"(
      tokenIds?: null,
      to?: string | null
    ): TypedEventFilter<
      [BigNumber[], string],
      { tokenIds: BigNumber[]; to: string }
    >;
