...
interface FeedVaultV2Interface extends ethers.utils.Interface {
  functions: {
    "MAX_FEE_PERCENT()": FunctionFragment;
    "ONE_HUNDRED_PERCENT()": FunctionFragment;
    "containerVault(uint256)": FunctionFragment;
    "createVault(string,string,string,uint256,uint256,uint256,uint256)": FunctionFragment;
    ...
    "warrantyFeeGlobal()": FunctionFragment;
  };
  ...
  encodeFunctionData(functionFragment: "projectFee", values: [string]): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "setWarrantyFeeGlobal",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "warrantyFeeGlobal",
    values?: undefined
  ): string;
  ...
  decodeFunctionResult(functionFragment: "projectFee", data: BytesLike): Result;
  decodeFunctionResult(
    functionFragment: "renounceOwnership",
    data: BytesLike
  ): Result;
...
export class FeedVaultV2 extends BaseContract {
  ...
  interface: FeedVaultV2Interface;
  ...
  functions: {
    ...
    projectFee(arg0: string, overrides?: CallOverrides): Promise<[BigNumber]>;
    ...
    setWarrantyFeeGlobal(
      _warrantyFeeGlobal: BigNumberish,
      overrides?: Overrides & { from?: string | Promise<string> }
    ): Promise<ContractTransaction>;
    ...
    warrantyFeeGlobal(overrides?: CallOverrides): Promise<[BigNumber]>;
  };
  ...
  populateTransaction: {
    ...
    warrantyFeeGlobal(overrides?: CallOverrides): Promise<PopulatedTransaction>;
  };
}
