...
interface StringInterface extends ethers.utils.Interface {
  functions: {
...
export class String extends BaseContract {
  ...
  compare(s1: string, s2: string, overrides?: CallOverrides): Promise<boolean>;
