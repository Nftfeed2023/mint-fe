...
interface TokenFactoryV1Interface extends ethers.utils.Interface {
  functions: {
  ...
  events: {
    "DeployToken(string,string,uint256)": EventFragment;
...
export class TokenFactoryV1 extends BaseContract {
  ...
  interface: TokenFactoryV1Interface;
  ...
  filters: {
    "DeployToken(string,string,uint256)"(
      ...
      [string, string, BigNumber],
      { name: string; symbol: string; totalSupply: BigNumber }
    >;
